...
export const AdminPanel = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url(${fondo})` }}>
            <div className="bg-white/80 p-8 rounded-lg shadow-lg w-full max-w-6xl bg-opacity-90">
                {/* Título y mensaje de bienvenida */}
                <h1 className="text-4xl font-bold text-center text-gray-800 mb-4">Panel de Administración</h1>
                <p className="text-center text-gray-600 text-xl mb-8">Bienvenido, <span className="font-semibold text-blue-600">{user}</span></p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                        ...
                        <p className="text-gray-600 mb-4">Administra los trámites disponibles en el sistema.</p>
                        <a
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                        ...
                        <p className="text-gray-600 mb-4">Gestiona los requisitos necesarios para los trámites.</p>
                        <a
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                        ...
                        <p className="text-gray-600 mb-4">Administra la información adicional de los trámites.</p>
                        <a
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                        ...
                        <p className="text-gray-600 mb-4">Gestiona los formatos asociados a los trámites.</p>
                        <a
                ...
                <p className="text-center text-gray-500 mt-8">
                    Utiliza las opciones anteriores para gestionar el sistema de manera eficiente.
                </p>
            </div>
        </div>
    );
